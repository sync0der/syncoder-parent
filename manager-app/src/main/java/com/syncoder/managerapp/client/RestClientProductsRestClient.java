...
import com.syncoder.managerapp.controller.payload.UpdateProductPayload;
...
public class RestClientProductsRestClient implements ProductsRestClient {
    ...
    @Override
    public Optional<Product> findProduct(int productsId) {
        try {
            return Optional.ofNullable(this.restClient.get()
                    .uri("catalogue-api/products/{productId}", productsId)
                    .retrieve()
                    .body(Product.class));
